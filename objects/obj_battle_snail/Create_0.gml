...
global.battle_snail[0, 5] = 2; //hard
...
global.battle_snail[1, 5] = 1; //even triple
...
global.battle_snail[2 ,5] = 1;//even triple
...
global.battle_snail[4, 1] = "Isn't that kind of a small world? It seems like you're missing out."; //middle point
...
global.battle_snail[4 ,5] = 3;//hard flip
...
global.battle_snail[5 ,5] = 2;//hard 
...
global.battle_snail[6 ,5] = 3;//hard flip
...
global.battle_snail[7 ,5] = 4;//even duo
...
global.battle_snail[8 ,5] = 2;//hard (1-4, ,5-6)
...
global.battle_snail[9 ,5] = 3;//hard flip (1-2, ,4-6)
...
global.battle_snail[10 ,5] = 2;//hard (1-4, ,5-6)
...
global.battle_snail[11 ,5] = 4;//even duo (1-4, ,5-6)
